...
export default function ExternalOnboardingScreen() {
      ...
      <View className="flex-1 justify-center items-center px-6">
        ...
        <View className="gap-3 w-full mt-8">
          <TouchableOpacity
            ...
            onPress={() => router.push('/onboarding/external/wallet-connect')}
          >
