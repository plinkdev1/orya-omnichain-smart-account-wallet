import type { ISwapProtocol, IStakingProtocol, ILendingProtocol, IAggregatorProtocol } from '../interfaces';
...
export declare abstract class ProtocolAdapter {
...
export type ProtocolAdapterInstance = ISwapProtocol | IStakingProtocol | ILendingProtocol | IAggregatorProtocol;
